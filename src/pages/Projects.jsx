...
export default function Projects() {
    const allProjects = [
        ...
        { title: 'Autonomous Robot Navigation', description: 'Raspberry Pi enabled robot that is able to detect and follow humans', github: 'https://github.com/AutomationKay/General-Projects/tree/main/Autonomous_Robot_Navigation', video: 'https://github.com/AutomationKay/General-Projects/raw/main/Autonomous_Robot_Navigation/video/following_robot.mp4', tools: ['CNN', '|', 'OpenCV', '|', 'YOLO'] },
        { title: 'Reinforcement Learning using Sonic', description: 'RL Project intended to train an AI agent to play Sonic the Hedgehog', github: 'https://github.com/AutomationKay/General-Projects/tree/main/Sonic_RL_Project', image: 'https://github.com/AutomationKay/General-Projects/raw/main/Sonic_RL_Project/images/sonic_log.gif', tools: ['Python', '|', 'Tensorflow', '|', 'Deep Learning'] },

...
export default function About() {
  return (
    <div className="w-full overflow-x-hidden">
      <motion.div {...pageMotion} className="flex flex-col items-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-neon-green mb-6 sm:mb-8 text-center">
          About Me
        </h2>

        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 sm:gap-8 lg:gap-10 max-w-6xl mx-auto w-full">
          {/* Portrait Image */}
          <div className="flex-shrink-0">
            <img 
              src="/images/portrait.jpg" 
              alt="Kamaal Bartlett" 
              className="w-48 h-48 sm:w-60 sm:h-60 rounded-full object-cover border-4 border-neon-green shadow-lg mx-auto" 
            />
          </div>

          {/* Text Content */}
          <div className="flex flex-col gap-6 sm:gap-8 flex-grow">
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-neon-blue leading-relaxed text-left">
